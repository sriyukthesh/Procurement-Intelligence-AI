...
export interface RiskWeights {
  ...
  collusionWeight: number;
  companyHistoryWeight: number;
  projectPerformanceWeight: number;
  legalRegulatoryWeight: number;
  debarmentWeight: number;
}
